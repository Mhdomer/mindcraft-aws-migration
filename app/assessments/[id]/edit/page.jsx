	...
	async function handleSubmit(e) {
		...
		try {
			...
			const assessmentData = removeUndefined({
				...
				courseTitle,
				type,
				// For regular assessments, store questions with clean structure
				// For game levels, questions array is left empty
				questions: type === 'gameLevel'
					? []
					: questions.map(q => {
						const questionData = {
							type: q.type,
				...
				// For game levels, store structured configuration
