...
export default function CreateGameLevelPage() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			// Save to Firestore (Firestore will auto-generate document ID)
			const docRef = await addDoc(collection(db, 'gameLevel'), gameData);
			...
			alert('Failed to create game level: ' + error.message);
		} finally {
			setSubmitting(false);
		}
	};
